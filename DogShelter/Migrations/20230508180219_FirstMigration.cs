        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adoption_Dog_IdDog",
                        column: x => x.IdDog,
                        principalTable: "Dog",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Adoption_User_IdUser",
                        column: x => x.IdUser,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adoption_IdDog",
                table: "Adoption",
                column: "IdDog");

            migrationBuilder.CreateIndex(
                name: "IX_Adoption_IdUser",
                table: "Adoption",
                column: "IdUser");

            migrationBuilder.CreateIndex(
                name: "IX_Dog_IdDetails",
                table: "Dog",
                column: "IdDetails");

            migrationBuilder.CreateIndex(
                name: "IX_Donation_IdUser",
                table: "Donation",
                column: "IdUser");
